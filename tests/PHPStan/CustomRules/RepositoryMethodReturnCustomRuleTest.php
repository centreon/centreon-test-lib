...
use Centreon\PHPStan\CustomRules\RepositoryMethodReturnCustomRule;
...
it(
    ...
    function () {
        ...
        $this->classMethodNodeInstance->expects($this->any())
                                        ->method('getReturnType')
                                        ->willReturn($this->identifierNodeInstanceForMethodReturnType);

        $this->identifierNodeInstanceForMethodReturnType->expects($this->any())
                                                        ->method('toString')
                                                        ->willReturn('string');
...
it(
    ...
    function () {
        ...
        $expectedResult = [
            CentreonRuleErrorBuilder::message(
                $this->identifierNodeInstanceForClassMethod->name .
                " must return and object or an array of objects."
            )->line($this->classMethodNodeInstance->getLine())->build(),
        ];
...
it(
    'should not return an error if Repository\'s find method returns either null, an object or an array of objects.',
    function () {
        $this->identifierNodeInstanceForClassMethod->name = 'findHostId';
...
it(
    'should not return an error if Repository\'s method get returns either an object or an array of objects.',
    function () {
        $this->identifierNodeInstanceForClassMethod->name = 'getHostId';
