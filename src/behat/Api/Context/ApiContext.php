...
class ApiContext implements Context
{
     ...
     */
    public function iSendDowntimeOnServiceFromHost(string $service, string $host)
    {
     ...
     */
    public function iListDowntimeOfServiceFromHost(string $service, string $host)
    {
        [$hostId, $serviceId] = $this->iWaitUntilServiceIsMonitored($service, $host);
     ...
     */
    public function theDowntimeOfServiceFromHostIsCancel(string $service, string $host)
    {
        [$hostId, $serviceId] = $this->iWaitUntilServiceIsMonitored($service, $host);
