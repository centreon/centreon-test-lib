...
class ACLActionConfigurationListingPage extends \Centreon\Test\Behat\ListingPage
{
    ...
    protected $objectClass = '\Centreon\Test\Behat\Administration\ACLActionConfigurationPage';
    ...
    public function __construct($context, $visit = true)
    {
        ...
        if ($visit) {
            $this->context->visit('main.php?p=50204');
        }
    ...
    {
        return $this->context->assertFindIn($element, 'css', 'td:nth-child(4)')->getText() == 'ENABLED' ? true : false;
    }
