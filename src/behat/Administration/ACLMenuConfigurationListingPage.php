...
class ACLMenuConfigurationListingPage extends \Centreon\Test\Behat\ListingPage
{
    ...
    protected $objectClass = '\Centreon\Test\Behat\Administration\ACLMenuConfigurationPage';
    ...
    public function __construct($context, $visit = TRUE)
    {
        ...
        if ($visit) {
            $this->context->visit('main.php?p=50201');
        }
