...
class HostGroupServiceConfigurationPage extends \Centreon\Test\Behat\ConfigurationPage
{
    const GENERAL_TAB = 1;
     ...
     * @var string
     */
    protected $listingClass = '\Centreon\Test\Behat\Configuration\HostGroupServiceConfigurationListingPage';
    ...
    public function __construct($context, $visit = true)
    {
        ...
        if ($visit) {
            $this->context->visit('main.php?p=60202&o=a');
        }
