...
class MetaServiceConfigurationListingPage extends \Centreon\Test\Behat\ListingPage
{
    protected $validField = 'input[name="searchMS"]';
    ...
    protected $objectClass = '\Centreon\Test\Behat\Configuration\MetaServiceConfigurationPage';
    ...
    public function __construct($context, $visit = true)
    {
        ...
        if ($visit) {
            $this->context->visit('main.php?p=60204');
        }
