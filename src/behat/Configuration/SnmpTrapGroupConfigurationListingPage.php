...
class SnmpTrapGroupConfigurationListingPage extends \Centreon\Test\Behat\ListingPage
{
    protected $validField = 'input[name="searchTM"]';
     ...
     * @var string
     */
    protected $objectClass = '\Centreon\Test\Behat\Configuration\SnmpTrapGroupConfigurationPage';
    ...
    public function __construct($context, $visit = true)
    {
        ...
        if ($visit) {
            $this->context->visit('main.php?p=61705');
        }
