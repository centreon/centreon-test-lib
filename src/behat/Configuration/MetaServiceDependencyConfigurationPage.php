...
class MetaServiceDependencyConfigurationPage extends \Centreon\Test\Behat\ConfigurationPage
{
     ...
     * @var string
     */
    protected $listingClass = '\Centreon\Test\Behat\Configuration\MetaServiceDependencyConfigurationListingPage';
    ...
    public function __construct($context, $visit = true)
    {
        ...
        if ($visit) {
            $this->context->visit('main.php?p=60411&o=a');
        }
