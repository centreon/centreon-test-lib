...
class HostDependencyConfigurationListingPage extends \Centreon\Test\Behat\ListingPage
{
    protected $validField = 'input[name="searchHD"]';
    ...
    protected $objectClass = '\Centreon\Test\Behat\Configuration\HostDependencyConfigurationPage';
    ...
    public function __construct($context, $visit = true)
    {
        ...
        if ($visit) {
            $this->context->visit('main.php?p=60407');
        }
