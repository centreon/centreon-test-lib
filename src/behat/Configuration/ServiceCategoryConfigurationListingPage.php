...
class ServiceCategoryConfigurationListingPage extends \Centreon\Test\Behat\ListingPage
{
    protected $validField = 'input[name="searchSC"]';
    ...
    protected $objectClass = '\Centreon\Test\Behat\Configuration\ServiceCategoryConfigurationPage';
    ...
    public function __construct($context, $visit = true)
    {
        ...
        if ($visit) {
            $this->context->visit('main.php?p=60209');
        }
