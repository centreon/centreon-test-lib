...
class ServiceGroupDependencyConfigurationPage extends \Centreon\Test\Behat\ConfigurationPage
{
     ...
     * @var string
     */
    protected $listingClass = '\Centreon\Test\Behat\Configuration\ServiceGroupDependencyConfigurationListingPage';
    ...
    public function __construct($context, $visit = true)
    {
        ...
        if ($visit) {
            $this->context->visit('main.php?p=60410&o=a');
        }
