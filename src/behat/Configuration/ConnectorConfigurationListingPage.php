...
class ConnectorConfigurationListingPage extends \Centreon\Test\Behat\ListingPage
{
    protected $validField = 'select[name="o1"]';
    ...
    protected $objectClass = '\Centreon\Test\Behat\Configuration\ConnectorConfigurationPage';
    ...
    public function __construct($context, $visit = true)
    {
        ...
        if ($visit) {
            $this->context->visit('main.php?p=60806');
        }
