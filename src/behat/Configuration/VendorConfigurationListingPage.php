...
class VendorConfigurationListingPage extends \Centreon\Test\Behat\ListingPage
{
     ...
     * @var string
     */
    protected $objectClass = '\Centreon\Test\Behat\Configuration\VendorConfigurationPage';
    ...
    public function __construct($context, $visit = true)
    {
        ...
        if ($visit) {
            $this->context->visit('main.php?p=61702');
        }
