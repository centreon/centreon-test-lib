...
class HostDependencyConfigurationPage extends \Centreon\Test\Behat\ConfigurationPage
{
    ...
    protected $properties = array(
        ...
        'hosts' => array(
            'select2',
            'select#dep_hostParents'
        ),
        'dependent_hosts' => array(
            'select2',
            'select#dep_hostChilds'
        ),
     ...
     * @var string
     */
    protected $listingClass = '\Centreon\Test\Behat\Configuration\HostDependencyConfigurationListingPage';
    ...
    public function __construct($context, $visit = true)
    {
        ...
        if ($visit) {
            $this->context->visit('main.php?p=60407&o=a');
        }
